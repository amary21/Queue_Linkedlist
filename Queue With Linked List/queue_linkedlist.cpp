...
class linkedlist{
private:
	Simpul* pPertama;//ptr kesimpul pertama
	Simpul* pAkhir;//ptr kesimpul akhir

public:
	linkedlist():pPertama(NULL), pAkhir(NULL){}//konstruktor
...
};//akhir class Queuelist
/*TOLONG UNTUK COPASER SETIDAKNYA KALAU MAU COPY PASTE PROGRAM INI BILANG DULU KE PEMILIK GITHUB INI!!!,
JANGAN SEENAKNYA COPAS DAN DI JADIKAN BAHAN PENGUMPULAN TUGAS!!!*/
int main(){
...
do {
	...
	cout<<"              QUEUE MENGGUNAKAN LINKED LIST            "<<endl;
 	...
 	switch (pilih)
 	{
	case 1: cout<<"Data Pemain Bola"<<endl;
 			cout<<"--------------------------------"<<endl;
